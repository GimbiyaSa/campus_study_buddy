...
const initializeDatabase = async () => {
  try {
    ...
    try {
      ...
      console.log('✅ Connected to Azure SQL Database for Group Service (via Azure Config)');
    } catch (azureError) {
      ...
      if (process.env.DATABASE_CONNECTION_STRING) {
        ...
        console.log('✅ Connected to Azure SQL Database for Group Service (via connection string)');
      } else {
