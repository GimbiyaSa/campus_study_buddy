...
async function updateUserStatistics(userId, university, updates) {
  try {
    ...
    user.statistics.totalStudyHours =
      (user.statistics.totalStudyHours || 0) + updates.totalStudyHours;
    user.statistics.topicsCompleted =
      (user.statistics.topicsCompleted || 0) + updates.topicsCompleted;
