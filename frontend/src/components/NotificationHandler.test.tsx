...
describe('NotificationHandler', () => {
  ...
  test('accepts partner request successfully', async () => {
    ...
    await waitFor(() => {
      expect(screen.queryByText('Alice Smith wants to be your study partner')).not.toBeInTheDocument();
    });
  });
  ...
  test('handles accept request error', async () => {
    ...
    await waitFor(() => {
      expect(window.alert).toHaveBeenCalledWith('Failed to accept partner request. Please try again.');
    });
  ...
  test('handles decline request error', async () => {
    ...
    // Should show error alert
    await waitFor(() => {
      expect(window.alert).toHaveBeenCalledWith('Failed to reject partner request. Please try again.');
    });
