...
export default function PartnerMatching({ onPartnerConnect }: PartnerMatchingProps) {
  ...
  const loadPartners = async () => {
    try {
      ...
      const uniquePartners = Array.from(allPartnersMap.values()).sort(
  ...
  const filterPartners = () => {
    ...
    if (filters.minCompatibilityScore > 0) {
      filtered = filtered.filter(
        (partner) => partner.compatibilityScore >= filters.minCompatibilityScore
      );
    }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">
            Discover compatible study partners using AI-powered matching
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFilters({ ...filters, minCompatibilityScore: parseFloat(e.target.value) })
                }
                className="w-full"
              />
            </div>
                  ...
                  <>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium ${getCompatibilityColor(
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    {selectedPartner.major} • {selectedPartner.year}
                  </p>
                </div>
